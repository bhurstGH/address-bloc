...
describe("ContactController", () => {
    ...
    describe("#addContact()", () => {
        ...
        it("should add a single contact into the book", done => {
            ...
            .then(contact => {
                ...
                expect(contacts.email).toBe("alice@alice.com");
                done();
            }).catch(err => {
                done();
            });
    ...
    describe("#getContacts()",() => {
        ...
        it("should return an empty an array when no contacts are available", done => {
    ...
    describe("search methods", () => {
        ...
        const alloy = ["Alloy Rodriguez", "111-111-1111", "alloy@guerrilla-games.com"];
        ...
        describe("#binarySearch()", () => {
            ...
            it("should return null when called with an empty array", () => {
                expect(this.book.binarySearch([], "Allow Rodriguez")).toBeNull();
            });
        ...
        describe("#search()", () => {
            ...
            it("should return null when a contact is not found", done => {
                this.book.addContact(...zelda)
                .then( () => {
